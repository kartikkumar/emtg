...
namespace EMTG { namespace Astrodynamics {
        ...
        vector<double>& central_body_state_mks)
	{
		...
		if (!(Universe->central_body_SPICE_ID == 10))
		{
			double central_body_state_relative_to_sun_in_km[6];

			//locate the central body's position w.r.t. the Sun
			Universe->locate_central_body(*epoch, central_body_state_relative_to_sun_in_km, options, generate_derivatives);

			spacecraft_position_relative_to_sun_in_km[0] = (central_body_state_relative_to_sun_in_km[0] + spacecraft_state_relative_to_central_body_in_km[0]);
			spacecraft_position_relative_to_sun_in_km[1] = (central_body_state_relative_to_sun_in_km[1] + spacecraft_state_relative_to_central_body_in_km[1]);
			spacecraft_position_relative_to_sun_in_km[2] = (central_body_state_relative_to_sun_in_km[2] + spacecraft_state_relative_to_central_body_in_km[2]);
		...
		EMTG::Astrodynamics::find_engine_parameters(options,
			                                        ...
			                                        *epoch - *launch_epoch,
			                                        ...
			                                        power, // kW
			                                        active_power, // kW
			                                        number_of_active_engines, // integer number
			                                        generate_derivatives, // bool switch
			                                        dTdP, // kN/kW 
			                                        dmdotdP, // kg/kW
			                                        dTdIsp, // kN/s
			                                        dmdotdIsp, // kg/s
