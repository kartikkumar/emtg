...
public:
	...
	//methods
	void rk8713M_step(double *x_left, double *x_right, double *u, std::vector <double> & f1, std::vector <double> & df1dTOF, const double & t_left, const double & dt_left_stepdTOF, const double & t_0, const double & h, const double & dhdTOF, double * error,
