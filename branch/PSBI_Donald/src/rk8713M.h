...
public:
	rk8713M();
	rk8713M(int ns_in, missionoptions* options);

	//destructor
	~rk8713M();

	//methods
	void rk8713M_step(const int & phase_num, std::vector <double> & u, const double & t_left, std::vector <double> & dt_left_stepdTOF, const double & t_0, const double & h, const double & dhdTOF, double * error,
	...
	void adaptive_step_int(double * x_left_in, EMTG::math::Matrix <double> & dx_left_indTOF, double * x_right_out, EMTG::math::Matrix <double> & dx_right_outdTOF, const int & phase_num, std::vector <double> & uleft, const double & t_left, std::vector <double> & dt_leftdTOF, const double& t_0, double & local_step, double & dlocal_stepdTOF, double * resumeH, double * resumeError, double const & PRECISION_TARGET,
