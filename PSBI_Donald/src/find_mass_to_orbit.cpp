...
void find_mass_to_orbit(double C3, double DLA, int LV_type, double* mass, double* dmdC3, missionoptions* options)
{
	...
	if (LV_type > 0)
	{
		...
		double a1[] = {-1.80995E-07,0.00E+00,2.70E-07,9.00E-08,0.00000077,-0.00000044,-0.00000075,0.00000069,-0.00000048,-0.0000005,0.00001949,0.00000051,-3.5649E-08, 0, 8.0e-7, 0,-3.5649E-08, 0, 8.0e-7, 0};
